...
begin
   Select count(M.codigo_modelo) into modeloTecnico from aviao A join modelo_has_tecnico M on nro_matricula=new.nro_tecnico where M.codigo_modelo=A.codigo_modelo;
